...
{
  flake = {
    homeConfigurations.tyler = inputs.home-manager.lib.homeManagerConfiguration {
      ...
      modules = [
        ...
        self.flake.homeModules

        (
          { pkgs, ... }:
          {
            imports = [
              self.flake.homeModules.fish
              self.flake.homeModules.starship
            ];
